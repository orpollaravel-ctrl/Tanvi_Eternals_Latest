...
@section('subhead')
    <title>Edit Payment Mode - Jewelry ERP</title>
@endsection

@section('subcontent')
    <h2 class="intro-y mt-10 text-lg font-medium">Edit Payment Mode</h2>
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-8">
            <div class="box p-5">
                ...
                <form method="POST" action="{{ route('paymentmodes.update', $paymentmode->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-5 flex items-center">
                        ...
                        <x-base.button type="submit" variant="primary">Update Payment Mode</x-base.button>
                    </div>
