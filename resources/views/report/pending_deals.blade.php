...
@section('subcontent')
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <div class="box p-5">
                @if (count($deals) > 0)
                    <x-base.table class="-mt-2 border-separate border-spacing-y-[10px]" style="text-align:center;">
                        <x-base.table.thead>
                            <x-base.table.tr>
                        ...
                        <tfoot>
                            <tr class="bg-slate-100 text-sm">
                                ...
                                <td class="border-b-0 bg-slate-100 font-semibold">{{ round(($deals->sum('amount') / $deals->sum('quantity') * 10), 3) }}</td>
