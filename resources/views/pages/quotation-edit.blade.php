                ...
                <form method="POST" action="{{ route('quotations.update', $quotation->id) }}">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input type="text" name="customer_name" value="{{ old('customer_name', $quotation->customer_name) }}" placeholder="Customer Name" required />
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input type="text" name="customer_code" value="{{ old('customer_code', $quotation->customer_code) }}" placeholder="Customer Code" required />
                        </div>
                            ...
                            <div class="flex gap-6 mt-2">
                                ...
                                @foreach($metals as $metal => $image)
                                    <label class="cursor-pointer text-center">
                                        ...
                                        <div class="metal-option {{ old('metal', $quotation->metal) == $metal ? 'selected' : '' }}" style="margin-left: 10px;">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <div class="flex gap-3 mt-2">
                                @foreach(['22k', '18k', '14k', '9k'] as $purity)
                                    <label class="{{ $optionClass }} {{ old('purity', $quotation->purity) == $purity ? $activeClass : '' }}">
                        ...
                        <div class="col-span-12">
                            ...
                            <div class="flex flex-wrap gap-3 mt-2">
                                @foreach(['SI-IJ', 'SI-GH', 'VS-GH', 'VVS-EF', 'VS-SIGH', 'VS-ISHI', 'SI-HI'] as $diamond)
                                    <label class="{{ $optionClass }} {{ old('diamond', $quotation->diamond) == $diamond ? $activeClass : '' }}">
