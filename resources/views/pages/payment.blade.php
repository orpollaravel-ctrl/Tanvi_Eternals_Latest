...
@section('subhead')
    <title>Payment - Midone - Tailwind HTML Admin Template</title>
@endsection
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
            ...
            <div class="mx-auto hidden text-slate-500 md:block">
                @isset($payment)
                    Showing {{ $payment->firstItem() }} to {{ $payment->lastItem() }} of {{ $payment->total() }} entries
                @endisset
            </div>
