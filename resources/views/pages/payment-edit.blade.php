...
@section('subhead')
    <title>Edit Payment - Midone</title>
@endsection
                    ...
                    <div class="grid grid-cols-3 gap-6 mt-6">
                        <div class="mt-3">
                            ...
                            <x-base.form-input
                                type="text"
                                name="serial_no"
                                value="{{ old('serial_no', $payment->serial_no) }}"
                                readonly
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-3">
                        ...
                        <div class="mt-3">
                            ...
                            <x-base.form-input
                                type="text"
                                name="client_code"
                                value="{{ old('client_code', $payment->client_code) }}"
                                placeholder="TE110BW"/>
                        </div>
                        <div class="mt-3">
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-3">
                        <div>
                            ...
                            <x-base.form-select name="bank_cash">
                                ...
                                <option value="bank" {{ old('bank_cash', $payment->bank_cash) == 'bank' ? 'selected' : '' }}>Bank</option>
                                <option value="cash" {{ old('bank_cash', $payment->bank_cash) == 'cash' ? 'selected' : '' }}>Cash</option>
                            </x-base.form-select>
                        </div>
                    </div>
