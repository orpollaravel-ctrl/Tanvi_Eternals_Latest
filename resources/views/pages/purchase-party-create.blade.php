...
@section('subhead')
    <title>Create Purchase Party - Jewelry ERP</title>
@endsection

@section('subcontent')
    <h2 class="intro-y mt-10 text-lg font-medium">Create Purchase Party</h2>
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-8">
            <div class="box p-5">
                ...
                <form method="POST" action="{{ route('purchase-parties.store') }}">
                    @csrf
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-textarea
                                ...
                                rows="3"
                                required
                            >{{ old('address') }}</x-base.form-textarea>
                        </div>
                    ...
                    <div class="mt-5 flex items-center">
                        ...
                        <x-base.button type="submit" variant="primary">Create Party</x-base.button>
                    </div>
                </form>
            </div>
        </div>
