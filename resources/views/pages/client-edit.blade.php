                ...
                <form method="POST" action="{{ route('client.update',$client->id) }}">
                    ...
                    <div class="grid grid-cols-2 gap-6 mt-6">
                        <div class="mt-3">
                            ...
                            <x-base.form-input type="text" name="code" value="{{ old('code',$client->code) }}" placeholder="TE110BW" />
                        </div>
                        <div class="mt-3">
                            <x-base.form-label>Name*</x-base.form-label>
                            <x-base.form-input type="text" name="name" value="{{ old('name',$client->name) }}" placeholder="GOLD LTD." />
                        </div>
                    </div>
