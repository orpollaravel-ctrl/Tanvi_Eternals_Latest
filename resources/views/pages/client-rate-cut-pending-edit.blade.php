...
@section('subhead')
    <title>Edit Client Rate Cut Pending - Midone</title>
@endsection

@section('subcontent')
    <h2 class="intro-y mt-10 text-lg font-medium">Edit Client Rate Cut Pending</h2>
    <div class="mt-5 grid grid-cols-8 gap-6">
        <div class="intro-y col-span-12 lg:col-span-8">
            <div class="box p-5">
                ...
                <form method="POST" action="{{ route('client-rate-cut-pending.update', $clientRateCutPending->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-6">
                        <div>
                            ...
                            <x-base.form-input type="text" name="invoice_no" value="{{ old('invoice_no', $clientRateCutPending->invoice_no) }}" placeholder="Invoice No" />
                        </div>
                        <div>
                            <x-base.form-label>Client Code</x-base.form-label>
                            <x-base.form-input type="text" name="client_code" value="{{ old('client_code', $clientRateCutPending->client_code) }}" placeholder="Client Code" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-3">
                        <div>
                            ...
                            <x-base.form-input type="text" name="client_name" value="{{ old('client_name', $clientRateCutPending->client_name) }}" placeholder="Client Name" />
                        </div>
                        <div>
                            <x-base.form-label>Transaction Date*</x-base.form-label>
                            <x-base.form-input type="date" name="transaction_date" value="{{ old('transaction_date', $clientRateCutPending->transaction_date?->format('Y-m-d')) }}" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-3">
                        <div>
                            ...
                            <x-base.form-input type="text" name="sales_person" value="{{ old('sales_person', $clientRateCutPending->sales_person) }}" placeholder="Sales Person" />
                        </div>
                        <div>
                            <x-base.form-label>Transaction No</x-base.form-label>
                            <x-base.form-input type="text" name="transaction_no" value="{{ old('transaction_no', $clientRateCutPending->transaction_no) }}" placeholder="Transaction No" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-3">
                        <div>
                            ...
                            <x-base.form-input type="number" step="0.001" class="text-right" id="pure_weight" name="pure_weight" value="{{ old('pure_weight', $clientRateCutPending->pure_weight) }}" placeholder="0.000" />
                        </div>
                        <div>
                            <x-base.form-label>Sale Rate*</x-base.form-label>
                            <x-base.form-input type="number" step="0.01" class="text-right" id="sale_rate" name="sale_rate" value="{{ old('sale_rate', $clientRateCutPending->sale_rate) }}" placeholder="0.00" />
                        </div>
                        <div>
                            <x-base.form-label>Amount</x-base.form-label>
                            <x-base.form-input type="number" step="0.01" class="text-right" id="amount" name="amount" value="{{ old('amount', $clientRateCutPending->amount) }}" placeholder="0.00" readonly />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-3">
                        <div>
                            ...
                            <x-base.form-input type="number" step="0.01" class="text-right" id="rate_cut" name="rate_cut" value="{{ old('rate_cut', $clientRateCutPending->rate_cut) }}" placeholder="0.00" />
                        </div>
                        <div>
                            <x-base.form-label>Amt</x-base.form-label>
                            <x-base.form-input type="number" step="0.01" class="text-right" id="amt" name="amt" value="{{ old('amt', $clientRateCutPending->amt) }}" placeholder="0.00" />
                        </div>
                        <div>
                            <x-base.form-label>Different Amt.</x-base.form-label>
                            <x-base.form-input type="number" step="0.01" class="text-right" id="diff_amt" name="diff_amt" value="{{ old('diff_amt', $clientRateCutPending->diff_amt) }}" placeholder="0.00" readonly />
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function calculateAmount() {
            ...
            // const calculatedAmount = (weight * rate).toFixed(3);
